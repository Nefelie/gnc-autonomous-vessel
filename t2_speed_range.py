...
class LaptopController:
    def __init__(self):
        ...
        self.filename = Path('T2_Aruco_' + self.current_time + '.csv')
        self.fn = Path("T2_Log_" + self.current_time + '.csv')
    ...
    def loop(self):
        ...
        if current_epoch_s - self.motor_start_time > 0 and current_epoch_s - self.motor_start_time < 5:
            linear_speed1 = 0.2

        if current_epoch_s - self.motor_start_time > 5 and current_epoch_s - self.motor_start_time < 10:
            linear_speed1 = 0.35

        if current_epoch_s - self.motor_start_time > 10 and current_epoch_s - self.motor_start_time < 15:
            linear_speed1 = 0.2
