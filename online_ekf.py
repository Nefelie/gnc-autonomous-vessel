...
class LaptopController:
    def __init__(self):
        ...
        self.WPs = [(init_MM_x, init_MM_y), (2, 1)]
        ...
        self.filename = Path('Test4_Aruco_' + self.current_time + '.csv')
        self.fn = Path("Test4_Log_" + self.current_time + '.csv')
